    ...
    return (
        <div>
            ...
            <div className={cn("box", "p-6 mt-6")}>
                <div
                    className="flex justify-between items-start flex-wrap gap-4 flex-col-reverse min-[500px]:items-center min-[500px]:flex-row">
                    <h5>{t("status")}</h5>
                </div>
                    ...
                    <LogsBlock
                        ...
                        children={
                            <div className="flex flex-col gap-2">
                                {/*<div*/}
                                {/*    className="relative -ml-4 lg:-ml-6 w-[calc(100%+32px)] lg:w-[calc(100%+48px)] mt-4">*/}
