    ...
    <div>
      ...
      <ul className="flex flex-col gap-2 text-sm leading-[1.5]">
        ...
        <li>
          ...
          безопасности персональных данных, предпринимаемые HOGYX (далее —
          Оператор).
        </li>
        ...
        <li>
          ...
          может получить о посетителях веб-сайта https://hogyx.io.
        </li>
        ...
        <li>
          ...
          сети интернет по сетевому адресу https://hogyx.io.
        </li>
        ...
        <li>
          2.10. Пользователь — любой посетитель веб-сайта https://hogyx.io.
        </li>
        ...
        <li>
          ...
          support@hogyx.io с пометкой «Актуализация персональных данных».
        </li>
        ...
        <li>
          ...
          на электронный адрес Оператора support@hogyx.io с пометкой «Отзыв
        ...
        <li>
          ...
          Оператору с помощью электронной почты support@hogyx.io.
        </li>
        ...
        <li>
          ...
          сети Интернет по адресу https://hogyx/politica.
        </li>
      </ul>
    </div>
  );
