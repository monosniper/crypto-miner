...
export const PrivacyPolicyPage = () => {
  ...
  return (
    <div>
      ...
      <ul className="flex flex-col gap-2 text-sm leading-[1.5]">
        <li className="font-semibold text-base">1. Общие положения</li>
        ...
        <li>
          ...
          безопасности персональных данных, предпринимаемые WHALES (далее —
          Оператор).
        </li>
        ...
        <li>
          ...
          может получить о посетителях веб-сайта https://app.whales-mining.space.
        </li>
        ...
        <li>
          ...
          сети интернет по сетевому адресу https://app.whales-mining.space..
        </li>
        ...
        <li>
          2.10. Пользователь — любой посетитель веб-сайта https://app.whales-mining.space..
        </li>
        ...
        <li>
          ...
          услуг; — на отзыв согласия на обработку персональных данных, а также,
        ...
        <li>
          ...
          данные электронный адрес номера телефонов год, месяц, дата и место
          рождения фотографии сведения об имущественном положении сведения о
          доходах Правовые основания Федеральный закон «Об информации,
          информационных технологиях и о защите информации» от 27.07.2006 N
          149-ФЗ Виды обработки персональных данных Отправка информационных
        ...
        <li>
          ...
          support@whales.io с пометкой «Актуализация персональных данных».
        </li>
        ...
        <li>
          ...
          на электронный адрес Оператора support@whales.io с пометкой «Отзыв
        ...
        <li>
          ...
          Оператору с помощью электронной почты support@whales.io.
        </li>
        ...
        <li>
          ...
          сети Интернет по адресу https://app.whales-mining.space./politica.
        </li>
      </ul>
    </div>
  );
